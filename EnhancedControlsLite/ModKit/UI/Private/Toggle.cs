...
namespace ModKit.Private {
    public static partial class UI {
        ...
        public static readonly GUIContent CheckOnContent = new(ModKit.UI.CheckGlyphOn);
        public static readonly GUIContent CheckOffContent = new(ModKit.UI.CheckGlyphOff);
        public static readonly GUIContent DisclosureOnContent = new(ModKit.UI.DisclosureGlyphOn);
        public static readonly GUIContent DisclosureOffContent = new(ModKit.UI.DisclosureGlyphOff);
        public static readonly GUIContent DisclosureEmptyContent = new(ModKit.UI.DisclosureGlyphEmpty);
